...
//   // const command = trimmedInput[0]; 
//   // const username = trimmedInput[1];
...
//   // else if(command == "/git"){
//   //   bot.sendMessage(
//   //     message.chat.id, `Here is your full details of git profile`
//   //   );
...
//   console.log(giturl, "wikiRandomApiUrl");
//   try {
...
//     const { login, name, bio, location, followers, following, public_repos } = allUserData;

//     console.log(login, "logindetails");
//     bot.sendMessage(id, `*${bio}*\n\n${location}`, {
//       parse_mode: "Markdown",
//     });
